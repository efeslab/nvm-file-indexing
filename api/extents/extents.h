 ...
 */
typedef struct mlfs_extent_header {
...
static inline laddr_t mlfs_ext_lblock(struct mlfs_extent *ex)
{
    return le32_to_cpu(ex->ee_block);
}

static inline laddr_t mlfs_idx_lblock(struct mlfs_extent_idx *ix)
{
 ...
 */
static inline paddr_t mlfs_ext_pblock(struct mlfs_extent *ex)
{
    paddr_t block;
 ...
 */
static inline paddr_t mlfs_idx_pblock(struct mlfs_extent_idx *ix)
{
    paddr_t block;
